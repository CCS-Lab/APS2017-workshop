...
# Write out data
#write.table(all_data, file = "~/Box Sync/CCSL/APS_workshop_2017/gng_m4_simulated_data.txt", row.names = F, col.names = T, sep = "\t")

fit_gng_m1 <- gng_m1(data = "~/Box Sync/CCSL/APS_workshop_2017/gng_m4_simulated_data.txt", 
                     niter = 2000, nwarmup = 1000, nchain = 2, ncore = 2)
fit_gng_m2 <- gng_m2(data = "~/Box Sync/CCSL/APS_workshop_2017/gng_m4_simulated_data.txt", 
                     niter = 2000, nwarmup = 1000, nchain = 2, ncore = 2)
fit_gng_m3 <- gng_m3(data = "~/Box Sync/CCSL/APS_workshop_2017/gng_m4_simulated_data.txt", 
                     niter = 2000, nwarmup = 1000, nchain = 2, ncore = 2)
fit_gng_m4 <- gng_m4(data = "~/Box Sync/CCSL/APS_workshop_2017/gng_m4_simulated_data.txt", 
                     niter = 2000, nwarmup = 1000, nchain = 2, ncore = 2)
